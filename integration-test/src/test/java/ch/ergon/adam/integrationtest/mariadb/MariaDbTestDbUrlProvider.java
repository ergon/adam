...
import ch.ergon.adam.mariadb.MariaDbFactory;
import ch.ergon.adam.mariadb.MariaDbTransactionWrapper;
...
public class MariaDbTestDbUrlProvider extends TestDbUrlProvider {
    ...
    protected String getDbUrl(String schema) {
        return getDbUrl(targetContainer) + "&currentSchema=" + schema;
    }
...
//        MariaDbTransactionWrapper transactionWrapper = MariaDbFactory.getTransactionWrapper(url);

...
public class MariaDbTransactionWrapper implements SchemaSource, SchemaSink, SqlExecutor {

    private static final Logger logger = LoggerFactory.getLogger(MariaDbTransactionWrapper.class);

    private final Connection dbConnection;
    private final Runnable closeHandler;
    JooqSqlExecutor sqlExecutor;
    MariaDbSink sqlSink;
    MariaDbSource sqlSource;
